<template>
  <div class="container text-start">
    ...
    <p>
      ...
      &#8220;you&#8221; or &#8220;your&#8221;) and Fun Day Planners, LLC
      (&#8220;Fun Day Planners, LLC&#8221;, &#8220;we&#8221;, &#8220;us&#8221;
      ...
      may not access and use the Website and Services. By accessing and using
      the Website and Services, you acknowledge that you have read, understood,
      and agree to be bound by the terms of this Agreement. You acknowledge that
      this Agreement is a contract between you and Fun Day Planners, LLC, even
    ...
    <p>
      ...
      warrant and represent that you are at least 13 years of age. If you create
    ...
    <p>
      ...
      intellectual property ownership or right to use of all submitted Content.
      We may, but have no obligation to, monitor and review the Content on the
      Website submitted or created using our Services by you. You grant us
      permission to access, copy, distribute, store, transmit, reformat, display
      and perform the Content of your user account solely as required for the
    ...
    <p>
      ...
      representations associated with such activity, is solely between you and
      the applicable third party. We shall have no liability, obligation or
    ...
    <p>
      ...
      This means if you click on the link and purchase an item, Fun Day
      Planners, LLC will receive an affiliate commission. We are not responsible
      ...
      review the legal statements and other conditions of use of any resource
      which you access through a link on the Website. Your linking to any other
    ...
    <p>
      ...
      transfer to you any intellectual property owned by Fun Day Planners, LLC
      or third parties, and all rights, titles, and interests in and to such
      property will remain (as between the parties) solely with Fun Day
      Planners, LLC. All trademarks, service marks, graphics and logos used in
      connection with the Website and Services, are trademarks or registered
      trademarks of Fun Day Planners, LLC or its licensors. Other trademarks,
      ...
      otherwise use any of Fun Day Planners, LLC or third party trademarks.
    </p>
    <h2 id="disclaimer-of-warranty">Disclaimer of warranty</h2>
    <p>
      You agree that such Service is provided on an &#8220;as is&#8221; and
      &#8220;as available&#8221; basis and that your use of the Website and
      Services is solely at your own risk. We expressly disclaim all warranties
    ...
    <p>
      To the fullest extent permitted by applicable law, in no event will Fun
      Day Planners, LLC, its affiliates, directors, officers, employees, agents,
      ...
      applicable law, the aggregate liability of Fun Day Planners, LLC and its
      affiliates, officers, employees, agents, suppliers and licensors relating
      to the services will be limited to an amount no greater than one dollar or
      any amounts actually paid in cash by you to Fun Day Planners, LLC for the
      prior one month period prior to the first event or occurrence giving rise
    ...
    <p>
      You agree to indemnify and hold Fun Day Planners, LLC and its affiliates,
    ...
    <p>
      ...
      procedural laws of Ohio, United States without regard to its rules on
      ...
      the subject matter hereof shall be the courts located in Ohio, United
      States, and you hereby submit to the personal jurisdiction of such courts.
